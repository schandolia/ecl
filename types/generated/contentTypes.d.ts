...
export interface ApiAgeGroupAgeGroup extends Schema.CollectionType {
  ...
  attributes: {
    ...
    min_age_in_months: Attribute.Integer;
    max_age_in_months: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiLearningDomainLearningDomain extends Schema.CollectionType {
  collectionName: 'learning_domains';
  info: {
    singularName: 'learning-domain';
    pluralName: 'learning-domains';
    displayName: 'LearningDomain';
    description: '';
  };
  options: {
    draftAndPublish: true;
